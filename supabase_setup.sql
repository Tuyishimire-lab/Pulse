...
UPDATE public.sites SET keywords = '["google search", "google translate", "google maps", "google scholar", "google drive"]' WHERE id = 'google';
UPDATE public.sites SET keywords = '["youtube music", "youtube premium", "youtube tv", "youtube kids", "youtube downloader"]' WHERE id = 'youtube';
UPDATE public.sites SET keywords = '["facebook login", "facebook signup", "facebook watch", "facebook marketplace", "facebook messenger"]' WHERE id = 'facebook';
UPDATE public.sites SET keywords = '["wikipedia dictionary", "wikipedia app", "wikipedia donate", "wikipedia english", "wikipedia citation"]' WHERE id = 'wikipedia';
UPDATE public.sites SET keywords = '["instagram login", "instagram search", "instagram downloader", "instagram story viewer", "instagram profile"]' WHERE id = 'instagram';
UPDATE public.sites SET keywords = '["chatgpt login", "chatgpt api", "chatgpt prompt builder", "chatgpt app", "chatgpt plus cost"]' WHERE id = 'chatgpt';
UPDATE public.sites SET keywords = '["reddit search", "reddit stock", "reddit login", "reddit popular", "reddit coins"]' WHERE id = 'reddit';
UPDATE public.sites SET keywords = '["x.com twitter", "x login", "x premium", "x analytics", "x developers"]' WHERE id = 'x';
UPDATE public.sites SET keywords = '["yahoo mail login", "yahoo finance", "yahoo news", "yahoo search", "yahoo weather"]' WHERE id = 'yahoo';
UPDATE public.sites SET keywords = '["amazon prime", "amazon tracking", "amazon customer service", "amazon prime video", "amazon jobs"]' WHERE id = 'amazon';
UPDATE public.sites SET keywords = '["yandex search", "yandex translate", "yandex mail", "yandex maps", "yandex browser"]' WHERE id = 'yandex';
UPDATE public.sites SET keywords = '["baidu search", "baidu translate", "baidu map", "baidu stock", "baidu fanyi"]' WHERE id = 'baidu';
UPDATE public.sites SET keywords = '["tiktok login", "tiktok coins", "tiktok download", "tiktok creator fund", "tiktok web"]' WHERE id = 'tiktok';
UPDATE public.sites SET keywords = '["netflix login", "netflix pricing", "netflix movies", "netflix plans", "netflix customer service"]' WHERE id = 'netflix';
UPDATE public.sites SET keywords = '["microsoft store", "microsoft 365 login", "microsoft teams", "microsoft support", "microsoft account"]' WHERE id = 'microsoft';
UPDATE public.sites SET keywords = '["office 365 login", "office depot", "office activation", "office app", "office online"]' WHERE id = 'office';
UPDATE public.sites SET keywords = '["linkedin login", "linkedin jobs", "linkedin premium", "linkedin learning", "linkedin recruiter"]' WHERE id = 'linkedin';
UPDATE public.sites SET keywords = '["weather radar", "weather channel", "weather tomorrow", "weather local", "weather forecast"]' WHERE id = 'weather';
UPDATE public.sites SET keywords = '["twitch prime", "twitch tv", "twitch subs", "twitch tracker", "twitch login"]' WHERE id = 'twitch';
UPDATE public.sites SET keywords = '["github desktop", "github login", "github actions", "github pages", "github copilot"]' WHERE id = 'github';
UPDATE public.sites SET keywords = '["zoom login", "zoom support", "zoom app", "zoom cloud meetings", "zoom extensions"]' WHERE id = 'zoom';
UPDATE public.sites SET keywords = '["ebay store", "ebay bidding", "ebay seller hub", "ebay buyer protection", "ebay jobs"]' WHERE id = 'ebay';
UPDATE public.sites SET keywords = '["pinterest search", "pinterest login", "pinterest downloader", "pinterest aesthetic", "pinterest extension"]' WHERE id = 'pinterest';
UPDATE public.sites SET keywords = '["quora login", "quora questions", "quora answers", "quora spaces", "quora app"]' WHERE id = 'quora';
UPDATE public.sites SET keywords = '["canva pro pricing", "canva templates", "canva login", "canva resumes", "canva logo maker"]' WHERE id = 'canva';
UPDATE public.sites SET keywords = '["duckduckgo search", "duckduckgo extension", "duckduckgo browser", "duckduckgo privacy", "duckduckgo mail"]' WHERE id = 'duckduckgo';
UPDATE public.sites SET keywords = '["imgur uploader", "imgur login", "imgur api", "imgur meme generator", "imgur app"]' WHERE id = 'imgur';
UPDATE public.sites SET keywords = '["spotify premium pricing", "spotify web player", "spotify login", "spotify wrapped", "spotify downloader"]' WHERE id = 'spotify';
UPDATE public.sites SET keywords = '["roblox robux", "roblox status", "roblox download", "roblox toys", "roblox account support"]' WHERE id = 'roblox';
UPDATE public.sites SET keywords = '["stackoverflow code", "stackoverflow api", "stackoverflow login", "stackoverflow survey", "stackoverflow career"]' WHERE id = 'stackoverflow';
UPDATE public.sites SET keywords = '["apple store online", "apple stock", "apple support", "apple id login", "apple release dates"]' WHERE id = 'apple';
UPDATE public.sites SET keywords = '["fandom wiki", "fandom app", "fandom support", "fandom login", "fandom guidelines"]' WHERE id = 'fandom';
UPDATE public.sites SET keywords = '["mail.ru login", "mail.ru search", "mail.ru games", "mail.ru client", "mail.ru translation"]' WHERE id = 'mailru';
UPDATE public.sites SET keywords = '["naver map", "naver translate", "naver dictionary", "naver webtoon", "naver blog"]' WHERE id = 'naver';
UPDATE public.sites SET keywords = '["bilibili video downloader", "bilibili app", "bilibili stock", "bilibili login", "bilibili global"]' WHERE id = 'bilibili';
UPDATE public.sites SET keywords = '["imdb top 250", "imdb movies", "imdb rating", "imdb app", "imdb cast"]' WHERE id = 'imdb';
UPDATE public.sites SET keywords = '["aliexpress shipping tracker", "aliexpress promo code", "aliexpress customer service", "aliexpress login", "aliexpress app"]' WHERE id = 'aliexpress';
UPDATE public.sites SET keywords = '["booking.com flight reservation", "booking.com customer service", "booking.com login", "booking.com cancellation policy", "booking.com affiliate program"]' WHERE id = 'booking';
UPDATE public.sites SET keywords = '["globo.com noticias", "globo play", "globo esporte", "globo g1", "globo gshow"]' WHERE id = 'globo';
UPDATE public.sites SET keywords = '["whatsapp web scanner", "whatsapp status check", "whatsapp download desktop", "whatsapp business api", "whatsapp support desk"]' WHERE id = 'whatsapp';
UPDATE public.sites SET keywords = '["adobe creative cloud", "adobe acrobat reader", "adobe photoshop pro", "adobe account status", "adobe fonts library"]' WHERE id = 'adobe';
UPDATE public.sites SET keywords = '["steam store key", "steam community hub", "steam status check", "steam refund guide", "steam sales calendar"]' WHERE id = 'steam';
UPDATE public.sites SET keywords = '["bbc iplayer schedule", "bbc news live feed", "bbc sport score tracker", "bbc weather update", "bbc radio player"]' WHERE id = 'bbc';
UPDATE public.sites SET keywords = '["cnn live feed tv", "cnn news breaking", "cnn business index", "cnn opinion desk", "cnn podcast stream"]' WHERE id = 'cnn';
UPDATE public.sites SET keywords = '["nytimes crosswords puzzle", "nytimes cooking recipes", "nytimes breaking news", "nytimes spelling bee", "nytimes subscription cost"]' WHERE id = 'nytimes';
UPDATE public.sites SET keywords = '["paypal log in", "paypal fee calculator", "paypal customer support", "paypal prepaid card", "paypal business portal"]' WHERE id = 'paypal';
UPDATE public.sites SET keywords = '["target circle login", "target weekly ad", "target delivery tracking", "target registry registry", "target credit card log"]' WHERE id = 'target';
UPDATE public.sites SET keywords = '["walmart online delivery", "walmart credit card login", "walmart pharmacy prescriptions", "walmart weekly flyer", "walmart careers portal"]' WHERE id = 'walmart';
UPDATE public.sites SET keywords = '["etsy seller login", "etsy shop builder", "etsy customer support", "etsy shipping tracking", "etsy promo codes"]' WHERE id = 'etsy';
UPDATE public.sites SET keywords = '["discord overlay settings", "discord status check", "discord bot developer", "discord login browser", "discord servers search"]' WHERE id = 'discord';
UPDATE public.sites SET keywords = '["telegram web login", "telegram channels search", "telegram desktop client", "telegram premium price", "telegram API keys"]' WHERE id = 'telegram';
UPDATE public.sites SET keywords = '["daily mail show", "daily mail news feed", "daily mail columnists", "daily mail health tips", "daily mail reader forum"]' WHERE id = 'dailymail';
UPDATE public.sites SET keywords = '["espn fantasy league", "espn live scores", "espn news headlines", "espn college ranks", "espn stream channel"]' WHERE id = 'espn';
UPDATE public.sites SET keywords = '["medium write post", "medium membership cost", "medium partner program", "medium reading list", "medium topic suggestions"]' WHERE id = 'medium';
UPDATE public.sites SET keywords = '["salesforce developer docs", "salesforce login trail", "salesforce admin cert", "salesforce app exchange", "salesforce dashboard build"]' WHERE id = 'salesforce';
UPDATE public.sites SET keywords = '["vimeo video download", "vimeo pricing model", "vimeo live streaming", "vimeo screen recorder", "vimeo support ticket"]' WHERE id = 'vimeo';
UPDATE public.sites SET keywords = '["dropbox basic login", "dropbox desktop app", "dropbox folder share", "dropbox smart sync", "dropbox business price"]' WHERE id = 'dropbox';
UPDATE public.sites SET keywords = '["slack desktop download", "slack app integrations", "slack price plans", "slack channel invite", "slack shortcut keys"]' WHERE id = 'slack';
UPDATE public.sites SET keywords = '["coinbase wallet login", "coinbase pro support", "coinbase transaction fees", "coinbase earn reward", "coinbase card support"]' WHERE id = 'coinbase';
UPDATE public.sites SET keywords = '["binance wallet import", "binance exchange login", "binance staking rewards", "binance card signup", "binance referral bonus"]' WHERE id = 'binance';
UPDATE public.sites SET keywords = '["investing.com portfolio monitor", "investing.com live tracker", "investing.com calendar list", "investing.com technical analysis", "investing.com mobile app"]' WHERE id = 'investing';
UPDATE public.sites SET keywords = '["bloomberg live terminal", "bloomberg market quotes", "bloomberg business news", "bloomberg podcast player", "bloomberg tv schedule"]' WHERE id = 'bloomberg';
UPDATE public.sites SET keywords = '["tradingview live ticker", "tradingview screener list", "tradingview pro discount", "tradingview script builder", "tradingview desktop app"]' WHERE id = 'tradingview';
UPDATE public.sites SET keywords = '["claude.ai api key", "claude.ai pricing plan", "claude.ai vs gpt4", "claude.ai developer guide", "claude.ai mobile app"]' WHERE id = 'claude';
UPDATE public.sites SET keywords = '["gemini api key", "gemini pricing plans", "gemini developer guide", "gemini code helper", "gemini model comparison"]' WHERE id = 'gemini';
UPDATE public.sites SET keywords = '["huggingface models library", "huggingface spaces build", "huggingface dataset download", "huggingface transformer guide", "huggingface api key"]' WHERE id = 'huggingface';
UPDATE public.sites SET keywords = '["midjourney prompt helper", "midjourney discord server", "midjourney cost plan", "midjourney gallery link", "midjourney web editor"]' WHERE id = 'midjourney';
UPDATE public.sites SET keywords = '["wikihow editor help", "wikihow article writer", "wikihow app download", "wikihow illustration tips", "wikihow random article"]' WHERE id = 'wikihow';
UPDATE public.sites SET keywords = '["merriam-webster dictionary search", "merriam-webster word of day", "merriam-webster thesaurus helper", "merriam-webster scrabble solver", "merriam-webster app download"]' WHERE id = 'merriamwebster';
UPDATE public.sites SET keywords = '["accuweather radar map", "accuweather local forecast", "accuweather severe storms", "accuweather hurricane track", "accuweather monthly forecast"]' WHERE id = 'accuweather';
UPDATE public.sites SET keywords = '["speedtest internet check", "speedtest app download", "speedtest results log", "speedtest server select", "speedtest cli install"]' WHERE id = 'speedtest';
UPDATE public.sites SET keywords = '["shopify themes templates", "shopify app store", "shopify store login", "shopify dropship guide", "shopify pricing plan"]' WHERE id = 'shopify';
UPDATE public.sites SET keywords = '["best buy weekly ad", "best buy member deals", "best buy customer support", "best buy store locator", "best buy order status"]' WHERE id = 'bestbuy';
UPDATE public.sites SET keywords = '["ikea catalog online", "ikea delivery fee", "ikea store locator", "ikea return policy", "ikea family rewards"]' WHERE id = 'ikea';
UPDATE public.sites SET keywords = '["nike sneakers release", "nike membership rewards", "nike order status", "nike custom shoes", "nike sizes guide"]' WHERE id = 'nike';
UPDATE public.sites SET keywords = '["craigslist rentals list", "craigslist garage sale", "craigslist posting rules", "craigslist safety guide", "craigslist search help"]' WHERE id = 'craigslist';
UPDATE public.sites SET keywords = '["patreon creator login", "patreon pricing tiers", "patreon search tool", "patreon app download", "patreon help center"]' WHERE id = 'patreon';
UPDATE public.sites SET keywords = '["soundcloud web player", "soundcloud login page", "soundcloud song download", "soundcloud artist account", "soundcloud go price"]' WHERE id = 'soundcloud';
UPDATE public.sites SET keywords = '["hulu pricing plans", "hulu student discount", "hulu movies library", "hulu live guide", "hulu app downloader"]' WHERE id = 'hulu';
UPDATE public.sites SET keywords = '["disney plus release calendar", "disney plus discount bundle", "disney plus watch list", "disney plus app download", "disney plus help desk"]' WHERE id = 'disneyplus';
UPDATE public.sites SET keywords = '["max live stream", "max movies list", "max student discount", "max app download", "max help center"]' WHERE id = 'max';
UPDATE public.sites SET keywords = '["deviantart wall art", "deviantart signup free", "deviantart custom commission", "deviantart app review", "deviantart tag search"]' WHERE id = 'deviantart';
UPDATE public.sites SET keywords = '["ign game reviews", "ign release dates", "ign live streams", "ign prime codes", "ign walk guides"]' WHERE id = 'ign';
UPDATE public.sites SET keywords = '["the guardian live feed", "the guardian breaking news", "the guardian daily puzzle", "the guardian opinion logs", "the guardian podcast list"]' WHERE id = 'theguardian';
UPDATE public.sites SET keywords = '["reuters finance tracker", "reuters breaking news", "reuters daily brief", "reuters business indexes", "reuters picture feed"]' WHERE id = 'reuters';
UPDATE public.sites SET keywords = '["forbes billionaire index", "forbes under 30", "forbes business index", "forbes magazine issue", "forbes daily newsletter"]' WHERE id = 'forbes';
UPDATE public.sites SET keywords = '["techcrunch disrupt ticket", "techcrunch startups list", "techcrunch daily email", "techcrunch video channel", "techcrunch index list"]' WHERE id = 'techcrunch';
UPDATE public.sites SET keywords = '["wired science papers", "wired tech news", "wired print issue", "wired daily update", "wired video reviews"]' WHERE id = 'wired';
UPDATE public.sites SET keywords = '["robinhood gold membership", "robinhood stock quotes", "robinhood instant transfer", "robinhood card support", "robinhood options guide"]' WHERE id = 'robinhood';
UPDATE public.sites SET keywords = '["stripe developer docs", "stripe checkout page", "stripe dashboard login", "stripe processing pricing", "stripe terminal reader"]' WHERE id = 'stripe';
UPDATE public.sites SET keywords = '["vercel deployment guide", "vercel domains select", "vercel serverless metrics", "vercel pricing plan", "vercel github link"]' WHERE id = 'vercel';
UPDATE public.sites SET keywords = '["netlify dns records", "netlify domains select", "netlify functions write", "netlify pricing plan", "netlify builder tool"]' WHERE id = 'netlify';
UPDATE public.sites SET keywords = '["npm registry lookup", "npm packages publish", "npm cli commands", "npm login terminal", "npm audit audit"]' WHERE id = 'npm';
UPDATE public.sites SET keywords = '["gitlab pipeline tools", "gitlab runner config", "gitlab login portal", "gitlab pricing page", "gitlab self hosted"]' WHERE id = 'gitlab';
UPDATE public.sites SET keywords = '["docker desktop setup", "docker hub repository", "docker files write", "docker run commands", "docker compose builder"]' WHERE id = 'docker';
UPDATE public.sites SET keywords = '["stackexchange sites list", "stackexchange reputation points", "stackexchange sign up", "stackexchange badges checklist", "stackexchange mobile app"]' WHERE id = 'stackexchange';
UPDATE public.sites SET keywords = '["wunderground weather map", "wunderground local radar", "wunderground severe alerts", "wunderground monthly stats", "wunderground app review"]' WHERE id = 'wunderground';
UPDATE public.sites SET keywords = '["airbnb flight bundle", "airbnb customer support", "airbnb host signup", "airbnb cancellation guide", "airbnb coupon promo"]' WHERE id = 'airbnb';
UPDATE public.sites SET keywords = '["uber ride booking", "uber eats menu", "uber driver login", "uber code coupon", "uber customer support"]' WHERE id = 'uber';
UPDATE public.sites SET keywords = '["figma team files", "figma design guide", "figma plugins lookup", "figma student discount", "figma mirror app"]' WHERE id = 'figma';
