...
export const STATIC_TRAFFIC_FACTS: { text: string; type: string }[] = [
  ...
  { text: "TRAFFIC INSIGHT: GitHub hosts over 420 million repositories from more than 100 million registered developers.", type: "insight" },
  { text: "TRAFFIC INSIGHT: Instagram sees over 500 million Stories created per day across its platform.", type: "insight" },
  { text: "TRAFFIC INSIGHT: LinkedIn processes over 1 million job applications every day through its platform.", type: "insight" },
  { text: "TRAFFIC INSIGHT: Cloudflare's network handles over 45 million HTTP requests per second at peak.", type: "insight" },
  { text: "TRAFFIC INSIGHT: Over 60% of global web traffic now comes from mobile devices, per Cloudflare Radar data.", type: "insight" },
  { text: "TRAFFIC INSIGHT: HTTP/3 adoption has crossed 30% of all global web traffic, reducing latency for billions of users.", type: "insight" },
