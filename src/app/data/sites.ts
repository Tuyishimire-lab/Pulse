...
export const SITES: SiteConfig[] = [
  ...
  { id: 'zoom', name: 'Zoom', url: 'https://zoom.us', rank: 25, category: 'dev', baseline: '950M / mo', baselineRaw: 950_000_000, rate: 361, logo: 'Z', color: '#2d8cff', glow: 'rgba(45, 140, 255, 0.15)', progress: 1.0 },
  { id: 'canva', name: 'Canva', url: 'https://canva.com', rank: 26, category: 'dev', baseline: '880M / mo', baselineRaw: 880_000_000, rate: 334, logo: 'Cv', color: '#00c4cc', glow: 'rgba(0, 196, 204, 0.15)', progress: 0.95 },
  { id: 'ebay', name: 'eBay', url: 'https://ebay.com', rank: 27, category: 'ecommerce', baseline: '820M / mo', baselineRaw: 820_000_000, rate: 312, logo: 'eB', color: '#e53238', glow: 'rgba(229, 50, 56, 0.15)', progress: 0.89 },
  { id: 'spotify', name: 'Spotify', url: 'https://spotify.com', rank: 28, category: 'entertainment', baseline: '650M / mo', baselineRaw: 650_000_000, rate: 247, logo: 'Sp', color: '#1db954', glow: 'rgba(29, 185, 84, 0.15)', progress: 0.70 },
  { id: 'quora', name: 'Quora', url: 'https://quora.com', rank: 29, category: 'reference', baseline: '610M / mo', baselineRaw: 610_000_000, rate: 232, logo: 'Q', color: '#b92b27', glow: 'rgba(185, 43, 39, 0.15)', progress: 0.66 },
  { id: 'duckduckgo', name: 'DuckDuckGo', url: 'https://duckduckgo.com', rank: 30, category: 'search', baseline: '560M / mo', baselineRaw: 560_000_000, rate: 213, logo: 'DD', color: '#de5833', glow: 'rgba(222, 88, 51, 0.15)', progress: 0.61 },
  { id: 'roblox', name: 'Roblox', url: 'https://roblox.com', rank: 31, category: 'entertainment', baseline: '580M / mo', baselineRaw: 580_000_000, rate: 220, logo: 'Rx', color: '#888888', glow: 'rgba(255, 255, 255, 0.05)', progress: 0.63 },
  { id: 'stackoverflow', name: 'Stack Overflow', url: 'https://stackoverflow.com', rank: 32, category: 'dev', baseline: '410M / mo', baselineRaw: 410_000_000, rate: 156, logo: 'SO', color: '#f48024', glow: 'rgba(244, 128, 36, 0.15)', progress: 0.44 },
  { id: 'imgur', name: 'Imgur', url: 'https://imgur.com', rank: 33, category: 'entertainment', baseline: '450M / mo', baselineRaw: 450_000_000, rate: 171, logo: 'Ig', color: '#1bb76e', glow: 'rgba(27, 183, 110, 0.15)', progress: 0.49 },
  { id: 'apple', name: 'Apple', url: 'https://apple.com', rank: 34, category: 'dev', baseline: '520M / mo', baselineRaw: 520_000_000, rate: 197, logo: 'Ap', color: '#a3aaae', glow: 'rgba(163, 170, 174, 0.15)', progress: 0.56 },
  { id: 'naver', name: 'Naver', url: 'https://naver.com', rank: 35, category: 'search', baseline: '400M / mo', baselineRaw: 400_000_000, rate: 152, logo: 'Nv', color: '#03c75a', glow: 'rgba(3, 199, 90, 0.15)', progress: 0.43 },
  { id: 'bilibili', name: 'Bilibili', url: 'https://bilibili.com', rank: 36, category: 'entertainment', baseline: '390M / mo', baselineRaw: 390_000_000, rate: 148, logo: 'Bl', color: '#00a1d6', glow: 'rgba(0, 161, 214, 0.15)', progress: 0.42 },
  { id: 'imdb', name: 'IMDb', url: 'https://imdb.com', rank: 37, category: 'reference', baseline: '370M / mo', baselineRaw: 370_000_000, rate: 141, logo: 'iM', color: '#e6b91e', glow: 'rgba(230, 185, 30, 0.15)', progress: 0.40 },
  { id: 'fandom', name: 'Fandom', url: 'https://fandom.com', rank: 38, category: 'reference', baseline: '360M / mo', baselineRaw: 360_000_000, rate: 137, logo: 'Fd', color: '#00d6d6', glow: 'rgba(0, 214, 214, 0.15)', progress: 0.39 },
  { id: 'aliexpress', name: 'AliExpress', url: 'https://aliexpress.com', rank: 39, category: 'ecommerce', baseline: '340M / mo', baselineRaw: 340_000_000, rate: 129, logo: 'AE', color: '#ff4747', glow: 'rgba(255, 71, 71, 0.15)', progress: 0.37 },
  { id: 'booking', name: 'Booking.com', url: 'https://booking.com', rank: 40, category: 'ecommerce', baseline: '330M / mo', baselineRaw: 330_000_000, rate: 125, logo: 'Bk', color: '#003580', glow: 'rgba(0, 53, 128, 0.15)', progress: 0.36 },
  // ── 41–60 ────────────────────────────────────────────────────────────────
  { id: 'discord', name: 'Discord', url: 'https://discord.com', rank: 41, category: 'social', baseline: '320M / mo', baselineRaw: 320_000_000, rate: 121, logo: 'Dc', color: '#5865f2', glow: 'rgba(88, 101, 242, 0.15)', progress: 0.35 },
  { id: 'telegram', name: 'Telegram', url: 'https://telegram.org', rank: 42, category: 'social', baseline: '300M / mo', baselineRaw: 300_000_000, rate: 114, logo: 'Tg', color: '#229ed9', glow: 'rgba(34, 158, 217, 0.15)', progress: 0.32 },
  { id: 'adobe', name: 'Adobe', url: 'https://adobe.com', rank: 43, category: 'dev', baseline: '310M / mo', baselineRaw: 310_000_000, rate: 118, logo: 'Ad', color: '#ff0000', glow: 'rgba(255, 0, 0, 0.15)', progress: 0.34 },
  { id: 'steam', name: 'Steam', url: 'https://store.steampowered.com', rank: 44, category: 'entertainment', baseline: '305M / mo', baselineRaw: 305_000_000, rate: 116, logo: 'St', color: '#171a21', glow: 'rgba(23, 26, 33, 0.15)', progress: 0.33 },
  { id: 'bbc', name: 'BBC', url: 'https://bbc.co.uk', rank: 45, category: 'news', baseline: '285M / mo', baselineRaw: 285_000_000, rate: 108, logo: 'BB', color: '#ae251f', glow: 'rgba(174, 37, 31, 0.15)', progress: 0.31 },
  { id: 'cnn', name: 'CNN', url: 'https://cnn.com', rank: 46, category: 'news', baseline: '260M / mo', baselineRaw: 260_000_000, rate: 98, logo: 'CN', color: '#cc0000', glow: 'rgba(204, 0, 0, 0.15)', progress: 0.28 },
  { id: 'mailru', name: 'Mail.ru', url: 'https://mail.ru', rank: 47, category: 'news', baseline: '330M / mo', baselineRaw: 330_000_000, rate: 125, logo: 'Mr', color: '#005eff', glow: 'rgba(0, 94, 255, 0.15)', progress: 0.36 },
  { id: 'globo', name: 'Globo', url: 'https://globo.com', rank: 48, category: 'news', baseline: '295M / mo', baselineRaw: 295_000_000, rate: 112, logo: 'Gb', color: '#ff4a4a', glow: 'rgba(255, 74, 74, 0.15)', progress: 0.32 },
  { id: 'nytimes', name: 'NY Times', url: 'https://nytimes.com', rank: 49, category: 'news', baseline: '250M / mo', baselineRaw: 250_000_000, rate: 95, logo: 'NY', color: '#555555', glow: 'rgba(255, 255, 255, 0.05)', progress: 0.27 },
  { id: 'paypal', name: 'PayPal', url: 'https://paypal.com', rank: 50, category: 'finance', baseline: '260M / mo', baselineRaw: 260_000_000, rate: 98, logo: 'PP', color: '#003087', glow: 'rgba(0, 48, 135, 0.15)', progress: 0.28 },
  { id: 'walmart', name: 'Walmart', url: 'https://walmart.com', rank: 51, category: 'ecommerce', baseline: '265M / mo', baselineRaw: 265_000_000, rate: 101, logo: 'Wm', color: '#0071dc', glow: 'rgba(0, 113, 220, 0.15)', progress: 0.29 },
  { id: 'target', name: 'Target', url: 'https://target.com', rank: 52, category: 'ecommerce', baseline: '228M / mo', baselineRaw: 228_000_000, rate: 87, logo: 'Tg', color: '#cc0000', glow: 'rgba(204, 0, 0, 0.15)', progress: 0.25 },
  { id: 'etsy', name: 'Etsy', url: 'https://etsy.com', rank: 53, category: 'ecommerce', baseline: '218M / mo', baselineRaw: 218_000_000, rate: 83, logo: 'Et', color: '#d5641c', glow: 'rgba(213, 100, 28, 0.15)', progress: 0.24 },
  { id: 'medium', name: 'Medium', url: 'https://medium.com', rank: 54, category: 'reference', baseline: '195M / mo', baselineRaw: 195_000_000, rate: 74, logo: 'Md', color: '#333333', glow: 'rgba(255, 255, 255, 0.05)', progress: 0.21 },
  { id: 'espn', name: 'ESPN', url: 'https://espn.com', rank: 55, category: 'entertainment', baseline: '210M / mo', baselineRaw: 210_000_000, rate: 80, logo: 'ES', color: '#ff002b', glow: 'rgba(255, 0, 43, 0.15)', progress: 0.23 },
  { id: 'salesforce', name: 'Salesforce', url: 'https://salesforce.com', rank: 56, category: 'dev', baseline: '198M / mo', baselineRaw: 198_000_000, rate: 75, logo: 'Sf', color: '#00a1e0', glow: 'rgba(0, 161, 224, 0.15)', progress: 0.21 },
  { id: 'vimeo', name: 'Vimeo', url: 'https://vimeo.com', rank: 57, category: 'entertainment', baseline: '178M / mo', baselineRaw: 178_000_000, rate: 68, logo: 'V', color: '#1ab7ea', glow: 'rgba(26, 183, 234, 0.15)', progress: 0.19 },
  { id: 'dropbox', name: 'Dropbox', url: 'https://dropbox.com', rank: 58, category: 'dev', baseline: '172M / mo', baselineRaw: 172_000_000, rate: 65, logo: 'Db', color: '#0061fe', glow: 'rgba(0, 97, 254, 0.15)', progress: 0.19 },
  { id: 'slack', name: 'Slack', url: 'https://slack.com', rank: 59, category: 'dev', baseline: '168M / mo', baselineRaw: 168_000_000, rate: 64, logo: 'Sl', color: '#4a154b', glow: 'rgba(74, 21, 75, 0.15)', progress: 0.18 },
  { id: 'dailymail', name: 'Daily Mail', url: 'https://dailymail.co.uk', rank: 60, category: 'news', baseline: '195M / mo', baselineRaw: 195_000_000, rate: 74, logo: 'DM', color: '#00356b', glow: 'rgba(0, 53, 107, 0.15)', progress: 0.21 },
  // ── 61–80 ────────────────────────────────────────────────────────────────
  { id: 'coinbase', name: 'Coinbase', url: 'https://coinbase.com', rank: 61, category: 'finance', baseline: '175M / mo', baselineRaw: 175_000_000, rate: 67, logo: 'Cb', color: '#0052ff', glow: 'rgba(0, 82, 255, 0.15)', progress: 0.19 },
  { id: 'binance', name: 'Binance', url: 'https://binance.com', rank: 62, category: 'finance', baseline: '158M / mo', baselineRaw: 158_000_000, rate: 60, logo: 'Bn', color: '#f3ba2f', glow: 'rgba(243, 186, 47, 0.15)', progress: 0.17 },
  { id: 'investing', name: 'Investing.com', url: 'https://investing.com', rank: 63, category: 'finance', baseline: '162M / mo', baselineRaw: 162_000_000, rate: 62, logo: 'Iv', color: '#1b4f72', glow: 'rgba(27, 79, 114, 0.15)', progress: 0.18 },
  { id: 'tradingview', name: 'TradingView', url: 'https://tradingview.com', rank: 64, category: 'finance', baseline: '185M / mo', baselineRaw: 185_000_000, rate: 70, logo: 'TV', color: '#131722', glow: 'rgba(19, 23, 34, 0.15)', progress: 0.20 },
  { id: 'bloomberg', name: 'Bloomberg', url: 'https://bloomberg.com', rank: 65, category: 'finance', baseline: '148M / mo', baselineRaw: 148_000_000, rate: 56, logo: 'Bm', color: '#3b5998', glow: 'rgba(59, 89, 152, 0.15)', progress: 0.16 },
  { id: 'claude', name: 'Claude.ai', url: 'https://claude.ai', rank: 66, category: 'ai', baseline: '420M / mo', baselineRaw: 420_000_000, rate: 160, logo: 'Cl', color: '#d97706', glow: 'rgba(217, 119, 6, 0.15)', progress: 0.45 },
  { id: 'gemini', name: 'Gemini', url: 'https://gemini.google.com', rank: 67, category: 'ai', baseline: '380M / mo', baselineRaw: 380_000_000, rate: 144, logo: 'Gm', color: '#4a90e2', glow: 'rgba(74, 144, 226, 0.15)', progress: 0.41 },
