      ...
      >
        ...
        >
          <div className="flex flex-col gap-6">
            ...
            <div className="p-5 sm:p-6 rounded-2xl bg-white/[0.02] border border-white/10 mb-6 text-left">
              ...
              <p className="text-sm sm:text-base leading-relaxed text-white/90 m-0">
                {details.description}
              </p>

              {/* 4-Chip Metadata Grid */}
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 mt-4 pt-4 border-t border-white/5 text-left">
            ...
            <div 
              className="p-5 sm:p-6 rounded-2xl bg-white/[0.02] border transition-all mt-6 text-left"
              style={{
