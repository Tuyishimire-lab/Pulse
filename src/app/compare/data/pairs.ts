...
export const COMPARE_PAIRS: ComparePair[] = [
  ...
  },
  {
    ...
    siteAId: 'google',
    siteBId: 'bing',
    verdict: 'Google is the undisputed search leader, processing over 90% of global search queries and receiving 92.5 billion monthly visits, roughly 27× more than its nearest rival.',
    context: 'The search engine market has been dominated by Google for two decades.',
    faq: [
      { q: 'How much more traffic does Google get than Bing?', a: 'Google receives approximately 92.5 billion monthly visits, while Bing processes around 1.2 billion, giving Google a roughly 70× traffic advantage by web visits.' },
  ...
  },
  {
    ...
    siteAId: 'facebook',
    siteBId: 'instagram',
    verdict: 'Facebook still leads in web traffic with 16.3B monthly visits vs Instagram\'s 10.4B, though Instagram is growing faster and leads in engagement among users under 35.',
    context: 'Two giants from the same parent company, Meta, competing for attention.',
    faq: [
      { q: 'Which is bigger, Facebook or Instagram?', a: 'Facebook receives 16.3 billion monthly visits compared to Instagram\'s 10.4 billion. However, Instagram has a higher engagement rate and is growing faster among younger demographics.' },
  ...
  },
  {
    ...
    siteAId: 'chatgpt',
    siteBId: 'google',
    verdict: 'Google processes 23× more web traffic than ChatGPT, but ChatGPT\'s growth trajectory is the fastest ever recorded for a consumer app. Google remains the default for information retrieval while ChatGPT leads for generative tasks.',
    context: 'The defining rivalry of the current AI era.',
    faq: [
      { q: 'Is ChatGPT taking traffic from Google?', a: 'Some studies suggest ChatGPT has influenced search behaviour, particularly among younger users, but Google\'s overall traffic has not declined measurably. Google receives 92.5B monthly visits vs ChatGPT\'s 7.2B.' },
      ...
      { q: 'How fast did ChatGPT grow?', a: 'ChatGPT reached 100 million users in 2 months, the fastest consumer app growth in history, and reached 7.2 billion monthly web visits by 2026.' },
    ],
  },
  {
  ...
  },
  {
    ...
    siteAId: 'instagram',
    siteBId: 'tiktok',
    verdict: 'Instagram still leads in web traffic with 10.4B monthly visits vs TikTok\'s 2.8B, but TikTok\'s engagement rate per user and time-in-app are significantly higher, especially among Gen Z.',
    context: 'The short-form visual content wars between Meta and ByteDance.',
    faq: [
      { q: 'Which is more popular, Instagram or TikTok?', a: 'Instagram has more web traffic (10.4B vs 2.8B monthly visits) and more total users (~2 billion vs ~1.5 billion). However, TikTok users spend more time per session and TikTok is growing faster among under-25s.' },
  ...
  },
  {
    ...
    siteAId: 'linkedin',
    siteBId: 'x',
    verdict: 'X (Twitter) receives more raw web traffic with 3.2B monthly visits vs LinkedIn\'s 1.5B, but LinkedIn generates stronger professional engagement and B2B advertising returns.',
    context: 'Professional networking vs. real-time public discourse.',
    faq: [
      { q: 'Which gets more traffic, LinkedIn or Twitter/X?', a: 'X (Twitter) receives approximately 3.2 billion monthly visits vs LinkedIn\'s 1.5 billion. However, LinkedIn\'s users have higher average income and professional intent, making it more valuable for B2B marketing.' },
  ...
  },
  {
    ...
    siteAId: 'duckduckgo',
    siteBId: 'google',
    verdict: 'Google processes 140× more searches than DuckDuckGo, but DuckDuckGo has carved out a loyal audience of privacy-conscious users and grew from 30M to 100M+ daily queries between 2020 and 2024.',
    context: 'Privacy-focused search versus the dominant search giant.',
    faq: [
      { q: 'How much traffic does DuckDuckGo get vs Google?', a: 'Google receives approximately 92.5 billion monthly visits vs DuckDuckGo\'s 600 million, a 140× difference. Google processes over 8.5 billion searches per day versus DuckDuckGo\'s approximately 100 million.' },
  ...
  },
  {
    ...
    siteAId: 'reddit',
    siteBId: 'x',
    verdict: 'X (Twitter) receives slightly more traffic than Reddit (3.2B vs 4.8B monthly visits), but Reddit\'s SEO authority has surged dramatically since 2023 due to Google prioritising community discussions.',
    context: 'Social discussion platforms competing for opinion-forming internet conversations.',
    faq: [
      { q: 'Which gets more traffic, Reddit or Twitter/X?', a: 'They are closely matched: Reddit receives approximately 4.8 billion and X receives 3.2 billion monthly visits. Reddit\'s traffic has grown faster since Google\'s 2023 algorithm update boosted discussion forums.' },
  ...
  },
  {
    ...
    siteAId: 'chatgpt',
    siteBId: 'google',
    verdict: 'Google\'s 92.5B monthly visits dwarf OpenAI\'s 7.2B, but ChatGPT remains the fastest-growing consumer internet product ever. The real battle is for the future of how people find information online.',
    context: 'The defining AI rivalry, large language models vs. traditional search.',
    faq: [
      { q: 'Is OpenAI/ChatGPT taking over from Google?', a: 'Not yet. Google receives 23× more monthly traffic than ChatGPT. However, ChatGPT\'s 100M user milestone in 2 months and continued growth signal a meaningful shift in how some users approach information discovery.' },
  ...
  },
  {
    ...
    siteAId: 'wikipedia',
    siteBId: 'quora',
    verdict: 'Wikipedia receives 6× more traffic than Quora (4.3B vs 700M monthly visits). Wikipedia\'s volunteer-edited, citation-backed model gives it more trust and SEO authority than Quora\'s expert Q&A.',
    context: 'Reference and knowledge platforms serving different information needs.',
    faq: [
      { q: 'Which gets more traffic, Wikipedia or Quora?', a: 'Wikipedia receives approximately 4.3 billion monthly visits versus Quora\'s 700 million, a 6× difference. Wikipedia ranks #4 globally while Quora is at #24.' },
  ...
  },
  {
    ...
    siteAId: 'x',
    siteBId: 'instagram',
    verdict: 'X (formerly Twitter) retains a massive web traffic lead at over 3.5B monthly visits. Meta\'s Threads launched to 100M users in 5 days but has struggled to maintain daily active engagement at the same level.',
    context: 'The real-time text conversation battle between X and Meta\'s Threads.',
    faq: [
      { q: 'Is Threads bigger than Twitter/X?', a: 'No. X receives approximately 2.8 billion monthly web visits. Threads had a record 100M sign-ups in its first week but daily active users dropped significantly after launch. X retains a large loyal user base for real-time news.' },
      { q: 'Why did people move from Twitter to Threads?', a: 'Many users migrated after Elon Musk\'s acquisition of Twitter in 2022, citing policy changes, API pricing changes, and content moderation concerns. Threads offered a familiar Instagram-linked alternative.' },
